    ...
    public class RemoteAnalysisKohtect
    {
        ...
        private void GetDevicestructure(byte[] devicedata)
        {
            ...
            try
            {
                ...
                //Read 
                ctrStructure = 12;
                _P_P = _RMS * (float)1.4142;// BytetoFloat(devicedata, ctrStructure);
                if (Is2Channel)
                {
                    ctrStructure = 16;
                    _P_P2 = _RMS * (float)4.2424; // BytetoFloat(devicedata, ctrStructure);
                }
        ...
        public bool FillRecordedData(int Fileid, string UserID, string PointID)
        {
            ...
            try
            {
                ...
                {
                    OverallValueChnl1 = _P_P; //_RMS;// _P_P;
                ...
                else if (Channel1AmplifierMode == 2)
                {
                    OverallValueChnl1 = _P_P2;//_RMS;
                    OverallUnitChnl1 = "um";
                }
                ...
                else if (Channel2AmplifierMode == 2)
                {
                    OverallValueChnl2 = _RMS2;
                    OverallUnitChnl2 = "um";
                }
                ...
                //#region ***Sanjay Code ******
                //if (Channel1AmplifierMode == 0 || Channel1AmplifierMode == 1 || Channel1AmplifierMode == 2)
                //{
