...
namespace VibExchange.Areas.RemoteAnalysis.Models
{
    ...
    public class PointData
    {
        ...
        public List<RPMDtl> lstRPM { get; set;}
            }
    ...
    public class BearingData
    {
        ...
        public List<RPMDtl> lstRPMDetails { get; set; }
    }
    ...
    public class Unit
    {
        ...
        public List<PointData> lstPointUnt { get; set; }

        [Required]
        [Display(Name = "RPM UP TO")]
        public string RPMUPTO { get; set; }
    ...
    public class RPMDtl
    {
        ...
        public string RPMUPTO { get; set;}
         ...
         [Required]
         [Display(Name = "rpmdriven")]
         public string rpmdriven;

         List<RPMDtl> lstRPM { get; set; }
    ...
    public class ConversionFWTtoFFT
    {
        public string convId { get; set; }
        [Required]
        [Display(Name = "TWF")]
        public string tWFFormat { get; set; }
